...
def CNN_resnet(train_images_normalized,train_labels,val_images_normalized,val_labels,test_images_normalized,test_labels):
    ...
    # train the model
    history = model.fit(train_images_prep, train_labels_cat, batch_size=32, epochs=17, 
    ...
    plt.savefig("AMLS_23_24_SN23071850\B\images\Training and testing resnet50.png")
    return history
